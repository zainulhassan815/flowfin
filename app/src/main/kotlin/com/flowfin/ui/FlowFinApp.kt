...
import com.flowfin.feature.debts.navigation.addDebtEntry
import com.flowfin.feature.debts.navigation.debtDetailEntry
import com.flowfin.feature.debts.navigation.recordPaymentEntry
...
import com.flowfin.feature.settings.navigation.categoriesEntry
import com.flowfin.feature.settings.navigation.settingsEntry
...
fun FlowFinApp() {
  ...
  val entryProvider = entryProvider {
    ...
    recordPaymentEntry(navigator)
    addDebtEntry(navigator)
    reportsEntry()
